...
%>
        ...
        <body>
            ...
            <div align="center">
                <form onsubmit="return Check()" action="selectindexgrade" method="post">
                    <h2 class="ttt">请选择需要查询成绩排名的学期课程：</h2>
                    <select name="xueqi" id="xueqi" onchange="window.location=this.value;">
    <option value="selectindexgrade?xueqi=<%="2015/2016(1)"  %>" <%=(xueqi.equals("2015/2016(1)")?"selected":"")%>>2015/2016(1)</option>
    <option value="selectindexgrade?xueqi=<%="2015/2016(2)"  %>" <%=(xueqi.equals("2015/2016(2)")?"selected":"")%>>2015/2016(2)</option>
    <option value="selectindexgrade?xueqi=<%="2016/2017(1)"  %>" <%=(xueqi.equals("2016/2017(1)")?"selected":"")%>>2016/2017(1)</option>
    <option value="selectindexgrade?xueqi=<%="2016/2017(2)"  %>" <%=(xueqi.equals("2016/2017(2)")?"selected":"")%>>2016/2017(2)</option>
</select>
            ...
            <div id="container">
                <table class="zebra">
                    ...
                    <c:forEach var="grade" items="${gradelist}" varStatus="status">
                        <tr>
                            <td align="center">${grade.getn()}</td>
                            <td align="center">${grade.getSno()}</td>
                            <td align="center">${grade.getSname()}</td>
